...
appRouter.post('/create-dollar-account', authMiddleware, VirtualAccountsController.createDollarAccount)
...
appRouter.get('/rates', authMiddleware, TransactionsController.getAllConversionRates)
// Webhook
